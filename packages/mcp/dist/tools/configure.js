    ...
    return [
        {
            ...
            inputSchema: {
                ...
                properties: {
                    apiKey: {
                        type: 'string',
                        description: "Your AgentID API key from agentidapp.com/settings/api-keys (starts with 'aid_')",
                    },
                    agentId: {
                        type: 'string',
                    ...
                    apiUrl: {
                        type: 'string',
                        description: 'Override the API base URL. Default: https://api.agentidapp.com',
                    },
                },
            },
            handler: async (args) => {
