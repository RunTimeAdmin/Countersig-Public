...
function Widget() {
  ...
  // Parse optional URL query params
  const params = new URLSearchParams(window.location.search);
  const chainParam = params.get('chain'); // optional chain filter
            ...
            {data?.chain_type && CHAIN_CONFIG[data.chain_type] && (
              <span
                style={{
                  ...
                  backgroundColor: `${CHAIN_CONFIG[data.chain_type].color}20`,
                  color: CHAIN_CONFIG[data.chain_type].color,
                  border: `1px solid ${CHAIN_CONFIG[data.chain_type].color}40`
                }}
              >
                {CHAIN_CONFIG[data.chain_type].label}
              </span>
            )}
